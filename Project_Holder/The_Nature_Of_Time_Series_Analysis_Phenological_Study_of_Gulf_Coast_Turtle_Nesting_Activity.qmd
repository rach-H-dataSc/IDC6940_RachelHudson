...
* RESULT: Stationary
* HOWEVER... AutoCorrelation Function (ACF) Plot behavior does NOT confirm Stationarity
* Highly Seasonal Data can make this happen
...
* Log Transform Additive = Multiplicative 
...
![](multiplicativeSTL.png){fig-align="right" height="275px"}
...
* Evaluate if the the beginning and end dates are shifting in relation to the peak nesting season
* Observe if the peak of the nesting season has been changing over time
* Spatial nesting activity  
...
## Questions? {background-color="#528B8B"}
