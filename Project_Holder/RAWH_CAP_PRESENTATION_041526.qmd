---
title: "The Nature of Times Series Analysis"
subtitle: "- Turtle Nesting Activity Mathematically Explained"
author: "Rachel Hudson (Advisor: Dr. Pu)"
date: '`r Sys.Date()`'
format:
  revealjs:
    background-color: "#f0f5f5"  # A very light grey-blue
...
## Introduction {.smaller background-color="aquamarine"}
...
## Methods{background-image="eggs.jpg" background-opacity="0.5"}
...
ggplot1 = murders %>% ggplot(mapping = aes(x=population/10^6, y=total)) 
  ...
  plotting <- ggplot1 + geom_point(aes(col=region), size = 4) +
