...
## Turtle Biology and Beyond {background-image="loggerhead.jpg" background-opacity="0.2"}
...
## TSA SARIMAX Components{.smaller background-image="turtletracks.jpg" background-opacity="0.2"}
...
## Exploratory Data Visualizations {.smaller background-image="turtletracks.jpg" background-opacity="0.2" background-size="cover"}

![](synchedNestvsTemp.png){fig-align="center"}

## Exploratory Data Visializations {.smaller background-image="turtletracks.jpg" background-opacity="0.2" background-size="cover"}

![](IndPlots.png){fig-align="center"}

## Box-Jenkins: Identification{.smaller background-image="turtletracks.jpg" background-opacity="0.2" background-size="cover"}
...
## Box-Jenkins: Estimation{.smaller background-image="turtletracks.jpg" background-opacity="0.2"}

::: {.columns}

::: {.column width="40%"}

* Monthly nest counts show high seasonality.
* Temperature acts as a strong exogenous variable..

:::

::: {.column width="60%"}

![](decompNest.png){fig-align="right" height="290px"}
![](decompTemp.png){fig-align="right" height="290px"}
...
## Box-Jenkins: Diagnostic Checks{.smaller background-image="turtletracks.jpg" background-opacity="0.2"}
...
![](ACFtemp.png)
:::
![](PACFtemp.png){fig-align="right" height="290px"}
:::
