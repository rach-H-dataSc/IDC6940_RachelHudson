...
* D = 1 added to stabilze the mean
...
* **Ljung-Box Test** (ACF Analysis) - the model can be viewed as a success given that the spikes at 12 and 24 are within the "insignificant" zone, spike at Lag 23 is a "shadow"
...
## Training and Validation{.smaller background-image="turtletracks.jpg" background-opacity="0.3"}
...
![](modelVal.png){align="center" height="300px"}

![](modVal2.png){align="center" height="100px"}

:::

:::::

## Forecasting and Metrics {.smaller background-image="turtletracks.jpg" background-opacity="0.2"}
...
## Conclusion {.smaller background-image="LoggerheadHatchlings.jpg" background-opacity="0.2"}
...
## Future Work: 2026 Forecast {.smaller background-image="LoggerheadHatchlings.jpg" background-opacity="0.2"}
