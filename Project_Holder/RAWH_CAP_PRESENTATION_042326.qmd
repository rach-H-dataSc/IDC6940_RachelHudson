...
* Florida is host to around **100,000 nests**
* Females return to nesting site **every 2 (or more) years**
* **Re-migration** of females
...
**AR (Autoregressive) Component, p** - involves the model using the relationship of the variable with its own **previous values** (or lagged observations).
    
**I (Integrated) Component, d** - helps to **stabilize the mean** and remove trends from the time series analysis; makes the model stationary by **differencing**.
    
**MA (Moving Average) Component, q** - represents the effect of **previous error** terms on the present value of the time series.
